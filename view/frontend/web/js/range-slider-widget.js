...
/*global alert*/
define(['jquery', 'Magento_Catalog/js/price-utils', 'mage/template', 'jquery-ui-modules/widget', 'jquery-ui-modules/slider', 'Magento_Ui/js/modal/modal', 'touchpunch'],
    function ($, priceUtil, mageTemplate) {

    "use strict";

    $.widget('mage.rangeSlider', {
        ...
        _refreshDisplay: function() {
            ...
            if (this.options.displayCount && this.element.find('[data-role=message-box]')) {
